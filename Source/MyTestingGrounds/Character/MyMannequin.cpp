...
void AMyMannequin::BeginPlay()
{
	...
	{
		InputComponent->BindAction("Fire", IE_Pressed, this, &AMyMannequin::PullTrigger);
	}
}

// Called every frame
void AMyMannequin::Tick(float DeltaTime)
{
...
void AMyMannequin::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	Super::SetupPlayerInputComponent(PlayerInputComponent);

}

void AMyMannequin::UnPossessed()
{
	Super::UnPossessed();
	if (!Gun) { return; }
	Gun->AttachToComponent(GetMesh(), FAttachmentTransformRules(EAttachmentRule::SnapToTarget, true), TEXT("GripPoint"));
